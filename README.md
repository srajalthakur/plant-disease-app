...
The model was trained using the New Plant Diseases Dataset available on Kaggle.

The dataset contains images of healthy and diseased plant leaves across multiple plant species.
